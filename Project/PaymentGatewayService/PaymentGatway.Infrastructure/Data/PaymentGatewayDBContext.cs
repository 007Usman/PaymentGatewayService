	...
	public class PaymentGatewayDBContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Currency>().ToTable("Currencies").HasData(
				new Currency { CurrencyId = Guid.NewGuid(), CurrencyCode = "GPB", CurrencyDescription = "British Pound", CreatedTimestamp = DateTimeOffset.Now, ModifiedTimestamp = DateTimeOffset.Now },
